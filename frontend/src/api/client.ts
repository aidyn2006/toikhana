import type { AuthResponse, BlogPost, Booking, City, OwnerApplication, Toikhana, ToikhanaCard, ToyType } from '../types';
...
export function getToyTypes() {
  return request<ToyType[]>('/api/toy-types');
}
