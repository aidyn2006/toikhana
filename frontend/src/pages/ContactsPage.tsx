  ...
  return (
    <main className="mx-auto max-w-4xl space-y-8 px-4 py-6 md:px-8 md:py-10">
      ...
      <section className="rounded-[2rem] bg-white p-8 shadow-soft">
        <p className="text-sm uppercase tracking-[0.3em] text-slate-500">{t('contacts.eyebrow')}</p>
        <h1 className="mt-3 font-serif text-4xl">{t('contacts.title')}</h1>
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <a className="rounded-2xl bg-background p-5" href="mailto:hello@toikhana.kz">
            <div className="text-sm text-slate-500">Email</div>
            <div className="mt-1 font-semibold">hello@toikhana.kz</div>
          </a>
          <a className="rounded-2xl bg-background p-5" href="https://wa.me/77000000000" target="_blank" rel="noreferrer">
