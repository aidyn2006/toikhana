...
const ru: Dict = {
  ...
  'about.text':
    'Мы делаем понятный каталог залов для тоя: быстрый поиск, карточки с фото, фильтры, заявки и отдельный поток для владельцев.',
...
const kk: Dict = {
  ...
  'about.text':
    'Біз той залдарының түсінікті каталогын жасаймыз: жылдам іздеу, фотосы бар карточкалар, сүзгілер, өтінімдер және иелерге арналған бөлек ағын.',
  ...
  'blog.intro':
    'Тойхана таңдау, бағалар және үйлену тойына, туған күнге және басқа да салтанаттарға дайындық бойынша кеңестер.',
  'blog.read': 'Оқу →',
